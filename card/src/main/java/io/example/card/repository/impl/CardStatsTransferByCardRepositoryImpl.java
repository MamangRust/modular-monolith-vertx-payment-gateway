    ...
    return pool
        .preparedQuery(
            """
                ...
                """)
        .execute(Tuple.of(getYearStart(req.getYear()), req.getCardNumber())).map(this::mapMonthAmountList);
  }
    ...
    return pool
        .preparedQuery(
            """
                ...
                """)
        .execute(Tuple.of(req.getYear(), req.getCardNumber())).map(this::mapYearAmountList);
  }
