...
High-availability Redis Cluster for secure, shared microservice caching.
...
Kafka for messaging and event streaming, running in modern, self-managed KRaft (Kafka Raft) mode without Zookeeper.
