...
public class MerchantDocumentCommandRepositoryImpl implements MerchantDocumentCommandRepository {
  ...
  public MerchantDocumentCommandRepositoryImpl(Pool pool) {
    this.pool = pool;
  }
  ...
  @Override
  public Future<MerchantDocument> trashedMerchantDocument(int merchantDocumentId) {
    String sql = """
  ...
  @Override
  public Future<MerchantDocument> restoreMerchantDocument(int merchantDocumentId) {
    String sql = """
  ...
  @Override
  public Future<Boolean> deleteMerchantDocumentPermanent(int merchantDocumentId) {
  ...
  @Override
  public Future<Boolean> restoreAllMerchantDocuments() {
  ...
  @Override
  public Future<Boolean> deleteAllMerchantDocumentsPermanent() {
