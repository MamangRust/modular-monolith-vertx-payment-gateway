...
public class MerchantStatsMethodRepositoryImpl implements MerchantStatsMethodRepository {
  ...
  @Override
  public Future<List<MerchantStats.MonthMethod>> getMonthlyPaymentMethodsMerchant(int year) {
    String sql = """
        WITH months AS (
  ...
  @Override
  public Future<List<MerchantStats.YearMethod>> getYearlyPaymentMethodMerchant(int year) {
    String sql = """
