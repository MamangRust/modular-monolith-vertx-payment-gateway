...
public class MerchantStatsTotalAmountRepositoryImpl implements MerchantStatsTotalAmountRepository {
  ...
  @Override
  public Future<List<MerchantStats.MonthAmount>> getMonthlyTotalAmountMerchant(int year) {
    String sql = """
  ...
  @Override
  public Future<List<MerchantStats.YearAmount>> getYearlyTotalAmountMerchant(int year) {
    String sql = """
        WITH yearly_data AS (
