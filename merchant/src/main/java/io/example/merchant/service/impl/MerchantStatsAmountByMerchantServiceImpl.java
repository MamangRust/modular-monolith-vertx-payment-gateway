...
public class MerchantStatsAmountByMerchantServiceImpl implements MerchantStatsAmountByMerchantService {
  ...
  public MerchantStatsAmountByMerchantServiceImpl(MerchantStatsAmountByMerchantRepository repository, RedisService redisService, TracingMetrics metrics) {
  ...
  @Override
  public Future<List<MerchantStats.MonthAmount>> getMonthlyAmounts(pb.merchant.Merchant.FindYearMerchantById req) {
  ...
  @Override
  public Future<List<MerchantStats.YearAmount>> getYearlyAmounts(pb.merchant.Merchant.FindYearMerchantById req) {
